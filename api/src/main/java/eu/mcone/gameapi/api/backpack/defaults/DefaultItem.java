...
public enum DefaultItem {
    ...
    SNOWGUN(2, "SnowGun", DefaultCategory.GADGET, Level.EPIC, 120,70, new ItemBuilder(Material.WOOD_HOE, 1, 0).displayName("§3§lSnowGun").lore("§7Kategorie: §bGadget", "§7Seltenheit: §5Episch", "", "", "§7Schieße das Weinachtfieber dürch die Lobby!").create()),
    ...
    BOMB(5, "Bombe", DefaultCategory.GADGET, Level.UNUSUAL, 80,50, new ItemBuilder(Material.TNT, 1).displayName("§3§lBombe").lore("§7Kategorie: §bGadget", "§7Seltenheit: §3Ungewöhnlich", "", "", "§7Achtung Sprengung!").create()),

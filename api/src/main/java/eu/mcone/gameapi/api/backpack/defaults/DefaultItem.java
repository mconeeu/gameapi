...
public enum DefaultItem {
    ...
    HEAD_LUIGI(18, "Luigis Kopf", DefaultCategory.HAT, Level.USUAL, 50, 20, Skull.fromUrl("http://textures.minecraft.net/texture/ff1533871e49ddab8f1ca82edb1153a5e2ed3764fd1ce029bf829f4b3caac3", 1).toItemBuilder().displayName("§7§lLuigi Kopf").lore("§7Kategorie: §bKopf", "§7Seltenheit: §7Gewöhnlich", "", "§7Mario wo bist den du ??").create()),
    ...
    HEAD_COMPUTER(30, "Computer Kopf", DefaultCategory.HAT, Level.USUAL, 50, 20, Skull.fromUrl("http://textures.minecraft.net/texture/45e9bd425fbd39a94c30bf5aeb301db186713322761fc82a76fb6168793490", 1).toItemBuilder().displayName("§7§lComputer Kopf").lore("§7Kategorie: §bKopf", "§7Seltenheit: §7Gewöhnlich", "", "§7DIREKT AUF DEM MCONE NETZWERK!").create()),
    ...
    HEAD_PENGUIN(35, "Pinguin Kopf", DefaultCategory.HAT, Level.USUAL, 80, 50, Skull.fromUrl("http://textures.minecraft.net/texture/d3c57facbb3a4db7fd55b5c0Odc7d19c19cb0813c748ccc9710c714727551f5b9", 1).toItemBuilder().displayName("§7§lPinguin Kopf").lore("§7Kategorie: §bKopf", "§7Seltenheit: §7Gewöhnlich", "", "§7Bohr ist das warm hier!").create()),
    ...
    HEAD_TWITCH(46, "Twitch Kopf", DefaultCategory.HAT, Level.UNUSUAL, 85, 55, Skull.fromUrl("http://textures.minecraft.net/texture/46be65f44cd21014c8cddd0158bf75227adcb1fd179f4c1acd158c88871a13f", 1).toItemBuilder().displayName("§3§lTwitch Kopf").lore("§7Kategorie: §bKopf", "§7Seltenheit: §3Ungewöhnlich", "", "§7Jetzt live auf Twitch!").create()),
    HEAD_COOKIE(47, "Cookie Kopf", DefaultCategory.HAT, Level.USUAL, 75, 45, Skull.fromUrl("http://textures.minecraft.net/texture/b592cf9f42a5a8c995968493fdd1b11e0b69aad6473ff45384abe58b7fc7c7", 1).toItemBuilder().displayName("§7§lCookie Kopf").lore("§7Kategorie: §bKopf", "§7Seltenheit: §7Gewöhnlich", "", "§7Krümelmonster?").create()),
    HEAD_SPOOKY_MASK(49, "Grusel Masken Kopf", DefaultCategory.HAT, Level.USUAL, 75, 45, Skull.fromUrl("http://textures.minecraft.net/texture/e9e94b7fb4bdb69b71f159db45682cc1681ae62a3c9a4d6c6b99b0f53bc62b79", 1).toItemBuilder().displayName("§7§lGrusel Maske Kopf").lore("§7Kategorie: §bKopf", "§7Seltenheit: §7Gewöhnlich", "", "§7Buh, erschreckt?").create()),
    HEAD_SNAPCHAT(50, "Snapchat Kopf", DefaultCategory.HAT, Level.UNUSUAL, 80, 55, Skull.fromUrl("http://textures.minecraft.net/texture/8735829ad0a878f960d794a61e3f1725ffd1a0d54f74cd94652cb69b24e3", 1).toItemBuilder().displayName("§3§lSnapchat Kopf").lore("§7Kategorie: §bKopf", "§7Seltenheit: §3Ungewöhnlich", "", "§7Rundsnaps für alle!").create()),
    HEAD_SUSHI(51, "Sushi Kopf", DefaultCategory.HAT, Level.EPIC, 110, 80, Skull.fromUrl("http://textures.minecraft.net/texture/23ca3f926e7a9ab9555fecb69a802743c122d9efc565a2fe5545118fa91d1", 1).toItemBuilder().displayName("§5§lSushi Kopf").lore("§7Kategorie: §bKopf", "§7Seltenheit: §5Episch", "", "§7Sind das Fischeier?").create()),
    HEAD_BREAD(52, "Brot Kopf", DefaultCategory.HAT, Level.USUAL, 70, 40, Skull.fromUrl("http://textures.minecraft.net/texture/f3487d457f9062d787a3e6ce1c4664bf7402ec67dd111256f19b38ce4f670", 1).toItemBuilder().displayName("§7§lBrot Kopf").lore("§7Kategorie: §bKopf", "§7Seltenheit: §7Gewöhnlich", "", "§7Mit oder ohne Butter").create()),
    HEAD_TWITTER(53, "Twitter Kopf", DefaultCategory.HAT, Level.EPIC, 110, 60, Skull.fromUrl("http://textures.minecraft.net/texture/3685a0be743e9067de95cd8c6d1ba21ab21d37371b3d597211bb75e43279", 1).toItemBuilder().displayName("§5§lTwitter Kopf").lore("§7Kategorie: §bKopf", "§7Seltenheit: §5Episch", "", "§7#MCONE").create()),
    HEAD_UP(55, "Hoch Kopf", DefaultCategory.HAT, Level.USUAL, 60, 35, Skull.fromUrl("http://textures.minecraft.net/texture/d48b768c623432dfb259fb3c3978e98dec111f79dbd6cd88f21155374b70b3c", 1).toItemBuilder().displayName("§7§lHoch Kopf").lore("§7Kategorie: §bKopf", "§7Seltenheit: §7Gewöhnlich", "", "§7Da hoch achso..").create()),

    HEAD_GIFT_SECRETS(56, "Secret Kopf", DefaultCategory.HAT, Level.USUAL, 60, 35, Skull.fromUrl("http://textures.minecraft.net/texture/16234ae7d55903ea8bc34413cd52ded3b37c92eee5ae533fc5126a65461f11f", 1).toItemBuilder().displayName("§7§lSecret Kopf").lore("§7Kategorie: §bKopf", "§7Seltenheit: §7Gewöhnlich", "", "§7Uh da ist was versteckt!").create()),


    //Gadget Heads
    HEAD_SECRET_STRIPCLUB(60, "Kirpha Kopf", DefaultCategory.HAT, Level.EPIC, 80, 50, Skull.fromUrl("http://textures.minecraft.net/texture/36aae86da0cd317a47fa6668fd4785b5a7a7e4ed9e7bc68652bae27984b84c", 1).toItemBuilder().displayName("§5§lLeichen Kopf").lore("§7Kategorie: §bKopf", "§7Seltenheit: §5Episch", "", "§7Kirphas 100 Jahre alter Kopf").create()),

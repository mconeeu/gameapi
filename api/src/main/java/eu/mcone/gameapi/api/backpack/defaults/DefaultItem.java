...
public enum DefaultItem {
    ...
    HEAD_UP(55, "Up Kopf", DefaultCategory.HAT, Level.USUAL, 60, 35, Skull.fromUrl("http://textures.minecraft.net/texture/d48b768c623432dfb259fb3c3978e98dec111f79dbd6cd88f21155374b70b3c", 1).toItemBuilder().displayName("§7§lHoch Kopf").lore("§7Kategorie: §bKopf", "§7Seltenheit: §7Gewöhnlich", "", "§7Da hoch achso..").create()),

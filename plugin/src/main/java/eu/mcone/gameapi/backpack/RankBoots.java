...
public enum RankBoots {
    ...
    YOUTUBER_BOOTS(Group.YOUTUBER, ItemBuilder.createLeatherArmorItem(Material.LEATHER_BOOTS, Color.PURPLE).displayName("§5§lYoutuber Schuhe").lore("§7Kategorie: §bExklusives Item", "§7Seltenheit: §5Episch", "", "§7Youtuber Boots").unbreakable(true).itemFlags(ItemFlag.HIDE_UNBREAKABLE).create()),

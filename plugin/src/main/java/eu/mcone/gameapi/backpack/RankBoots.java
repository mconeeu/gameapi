...
public enum RankBoots {
    ...
    ONE_BOOTS(Group.ONE, ItemBuilder.createLeatherArmorItem(Material.LEATHER_BOOTS, Color.AQUA).displayName("§5§lOne Schuhe").lore("§7Kategorie: §bExklusives Item", "§7Seltenheit: §5Episch", "", "§7One Boots").unbreakable(true).itemFlags(ItemFlag.HIDE_UNBREAKABLE).create()),
